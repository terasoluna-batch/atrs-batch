...
/**
 * 区間搭乗者情報集計結果オブジェクト変換用Mapperインタフェース。
 *
 * @author 電電 次郎
 */
@Mapper
public interface RouteAggregationResultDtoMapper {

    /**
     * RouteAggregationResultDtoからRouteAggregationDtoへの変換処理。
     *
     * @param routeAggregationResultDto
     * @return 区間搭乗者情報集計オブジェクト
     */
    RouteAggregationDto map(RouteAggregationResultDto routeAggregationResultDto);
}
