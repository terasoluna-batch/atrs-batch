...
/**
 * 予約情報集計結果オブジェクト変換用Mapperインタフェース。
 *
 * @author 電電 次郎
 */
@Mapper
public interface ReservationResultDtoMapper {

    /**
     * ReservationResultDtoからReservationDtoへの変換処理。
     *
     * @param reservationResultDto
     * @return 予約情報集計オブジェクト
     */
    ReservationDto map(ReservationResultDto reservationResultDto);
}
